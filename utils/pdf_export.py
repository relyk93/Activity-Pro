...
Generates printable weekly calendars and resident reports.
Uses only the built-in html module + weasyprint if available,
falls back to plain HTML download if not.
"""
import io
import textwrap
